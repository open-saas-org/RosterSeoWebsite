// Small stroke-based icon set, hand-drawn to match the site's line weight —
// no icon library dependency for a handful of one-off marks.
...
export function StarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12 .6l3.4 7 7.7 1.1-5.6 5.4 1.3 7.7L12 18.1l-6.8 3.7 1.3-7.7-5.6-5.4 7.7-1.1L12 .6z" />
    </svg>
  );
}
...
export function GitBranchIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M8.6 7.4L15.4 10.6M8.6 16.6L15.4 13.4" />
    </svg>
  );
}

export function NoLockIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
